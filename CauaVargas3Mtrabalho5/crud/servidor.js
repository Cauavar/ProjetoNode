...
app.post('/createFilme', function (req, res) {
    ...
    Form.parse(req, (err, fields, files) => {
        ...
        var sql = "INSERT INTO filme (nomeFilme, diretor, ano, imagem) VALUES ?";
        var values = [
            [fields['nomeFilme'], fields['diretor'], fields['ano'], nomeIMG]];
        con.query(sql, [values], function (err, result) {
            if (err) throw err;
        });
    });
...
app.post('/edit/:id', function (req, res) {
    ...
    form.parse(req, (err, fields, files) => {
        ...
        var sql2 = "UPDATE filme SET nomeFilme = ?, diretor = ?, ano = ?, imagem = ? WHERE id = ?";
        var values2 = [
        [fields['nomeFilme']],
        [fields['diretor']],
        [fields['ano']],
